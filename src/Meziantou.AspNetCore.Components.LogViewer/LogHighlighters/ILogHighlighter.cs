...
/// <summary>
/// Defines a highlighter that can process and mark parts of log messages for special rendering.
/// </summary>
public interface ILogHighlighter
{
    /// <summary>
    /// Processes the specified text and returns a collection of highlight results.
    /// </summary>
