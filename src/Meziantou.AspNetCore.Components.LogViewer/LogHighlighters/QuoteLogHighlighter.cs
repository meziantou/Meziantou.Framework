...
/// <summary>
/// A log highlighter that detects and highlights quoted strings (both single and double quotes) in log messages.
/// </summary>
public sealed partial class QuoteLogHighlighter : ILogHighlighter
{
    /// <summary>
    /// Processes the specified text and identifies quoted strings to be highlighted.
    /// </summary>
