...
{
    /// <summary>
    /// Logs that contain the most detailed messages. These messages may contain sensitive application data and should not be enabled in a production environment.
    /// </summary>
    Trace,
