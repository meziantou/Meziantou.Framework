...
internal sealed class InterceptionData : IEquatable<InterceptionData?>
{
    ...
    public override bool Equals([NotNullWhen(true)] object? obj) => Equals(obj as InterceptionData);
    public bool Equals([NotNullWhen(true)] InterceptionData? other) => other is not null && Kind == other.Kind && EqualityComparer<InterceptableLocation>.Default.Equals(InterceptableLocation, other.InterceptableLocation);
