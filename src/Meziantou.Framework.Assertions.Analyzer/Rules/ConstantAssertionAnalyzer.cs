...
public sealed class ConstantAssertionAnalyzer : DiagnosticAnalyzer
{
    ...
    /// </summary>
    private static bool IsSideEffectFreeReference(IOperation operation)
        => operation is ILocalReferenceOperation or IParameterReferenceOperation or IFieldReferenceOperation;
}
