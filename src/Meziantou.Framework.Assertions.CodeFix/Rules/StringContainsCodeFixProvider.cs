...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(StringContainsCodeFixProvider))]
public sealed class StringContainsCodeFixProvider : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        [RuleIdentifiers.UseStringContainsDiagnosticId, RuleIdentifiers.UseStringDoesNotContainDiagnosticId];
