...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(StringEndsWithCodeFixProvider))]
public sealed class StringEndsWithCodeFixProvider : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        [RuleIdentifiers.UseStringEndsWithDiagnosticId, RuleIdentifiers.UseStringDoesNotEndWithDiagnosticId];
