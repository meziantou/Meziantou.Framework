...
{
    public static void Collection<T>([NotNull] IEnumerable<T>? actual, Action<T>[] inspectors, string? message = null, [CallerArgumentExpression(nameof(actual))] string? actualExpression = null)
    {
        if (actual is null)
        {
            ThrowNullCollection(nameof(Collection), actualExpression, message, "Expected count", inspectors.Length.ToString(CultureInfo.InvariantCulture));
        }

        using var actualSnapshot = CollectionSnapshot.Create<T>(actual);

        // Reading one item past the inspectors decides whether the counts match, so an infinite sequence is not drained
        if (actualSnapshot.TryGetItem(inspectors.Length, out _) || (inspectors.Length > 0 && !actualSnapshot.TryGetItem(inspectors.Length - 1, out _)))
        {
    ...
    public static void Collection<T>([NotNull] IEnumerable<T>? actual, string? message = null, [CallerArgumentExpression(nameof(actual))] string? actualExpression = null)
    {
        Collection(actual, [], message, actualExpression);
    }

    public static void Collection<T>([NotNull] IEnumerable<T>? actual, Action<T> inspector1, string? message = null, [CallerArgumentExpression(nameof(actual))] string? actualExpression = null)
    {
        Collection(actual, [inspector1], message, actualExpression);
    }

    public static void Collection<T>([NotNull] IEnumerable<T>? actual, Action<T> inspector1, Action<T> inspector2, string? message = null, [CallerArgumentExpression(nameof(actual))] string? actualExpression = null)
    {
        Collection(actual, [inspector1, inspector2], message, actualExpression);
    }

    public static void Collection<T>([NotNull] IEnumerable<T>? actual, Action<T> inspector1, Action<T> inspector2, Action<T> inspector3, string? message = null, [CallerArgumentExpression(nameof(actual))] string? actualExpression = null)
    {
        Collection(actual, [inspector1, inspector2, inspector3], message, actualExpression);
    }

    public static void Collection<T>([NotNull] IEnumerable<T>? actual, Action<T> inspector1, Action<T> inspector2, Action<T> inspector3, Action<T> inspector4, string? message = null, [CallerArgumentExpression(nameof(actual))] string? actualExpression = null)
    {
        Collection(actual, [inspector1, inspector2, inspector3, inspector4], message, actualExpression);
    }

    public static void Collection<T>([NotNull] IEnumerable<T>? actual, Action<T> inspector1, Action<T> inspector2, Action<T> inspector3, Action<T> inspector4, Action<T> inspector5, string? message = null, [CallerArgumentExpression(nameof(actual))] string? actualExpression = null)
    {
        Collection(actual, [inspector1, inspector2, inspector3, inspector4, inspector5], message, actualExpression);
    }

    public static void Collection<T>([NotNull] IEnumerable<T>? actual, Action<T> inspector1, Action<T> inspector2, Action<T> inspector3, Action<T> inspector4, Action<T> inspector5, Action<T> inspector6, string? message = null, [CallerArgumentExpression(nameof(actual))] string? actualExpression = null)
    {
        Collection(actual, [inspector1, inspector2, inspector3, inspector4, inspector5, inspector6], message, actualExpression);
    }

    public static void Collection<T>([NotNull] IEnumerable<T>? actual, Action<T> inspector1, Action<T> inspector2, Action<T> inspector3, Action<T> inspector4, Action<T> inspector5, Action<T> inspector6, Action<T> inspector7, string? message = null, [CallerArgumentExpression(nameof(actual))] string? actualExpression = null)
    {
        Collection(actual, [inspector1, inspector2, inspector3, inspector4, inspector5, inspector6, inspector7], message, actualExpression);
    }

    public static void Collection<T>([NotNull] IEnumerable<T>? actual, Action<T> inspector1, Action<T> inspector2, Action<T> inspector3, Action<T> inspector4, Action<T> inspector5, Action<T> inspector6, Action<T> inspector7, Action<T> inspector8, string? message = null, [CallerArgumentExpression(nameof(actual))] string? actualExpression = null)
    {
