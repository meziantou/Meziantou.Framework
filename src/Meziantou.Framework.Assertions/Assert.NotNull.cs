...
{
    public static object NotNull(object? actual, [CallerArgumentExpression(nameof(actual))] string? actualExpression = null)
    {
    ...
    public static T NotNull<T>(T? actual, [CallerArgumentExpression(nameof(actual))] string? actualExpression = null)
        where T : struct
    {
        if (actual.HasValue)
