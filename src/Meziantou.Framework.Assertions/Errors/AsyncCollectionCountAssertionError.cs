...
internal readonly struct AsyncCollectionCountAssertionError<T>(string assertionName, string expectedCount, int actualCount, AsyncCollectionSnapshot<T> actualValue, string? actualExpression)
{
