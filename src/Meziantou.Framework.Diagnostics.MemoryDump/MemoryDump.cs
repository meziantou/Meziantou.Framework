...
/// <remarks>
/// <para>On Windows, the dump is written using <c>MiniDumpWriteDump</c> from <c>dbghelp.dll</c>. On Linux and macOS, the dump is written by the <c>createdump</c> tool shipped with the .NET runtime.</para>
