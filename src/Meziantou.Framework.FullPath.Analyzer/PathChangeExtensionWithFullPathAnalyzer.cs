...
public sealed class PathChangeExtensionWithFullPathAnalyzer : DiagnosticAnalyzer
{
    ...
    private static void Analyze(OperationAnalysisContext context, FullPathContext analyzerContext)
    {
        ...
        if (invocationOperation.TargetMethod is not { IsStatic: true, Name: "ChangeExtension" } targetMethod)
            return;
