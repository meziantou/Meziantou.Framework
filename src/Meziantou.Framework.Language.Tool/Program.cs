...
internal static class Program
{
    ...
    {
        var rootCommand = new RootCommand("Inspect INI, JSON, TOML, XML, regular expression, and shell documents");
    ...
    private static void AddSyntaxCommand(RootCommand rootCommand, TextReader? input)
    {
        ...
        {
            Description = "Dump the syntax tree of an INI, JSON, TOML, XML, regular expression, or shell document as JSON",
        };
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (string.IsNullOrEmpty(outputFile))
        {
            ...
            {
                SyntaxTreeJsonWriter.Write(writer, language.ParseText(text), language, options);
            }
