...
internal static class ShellSyntaxTreeWriter
{
    public static void Write(Utf8JsonWriter writer, ShellSyntaxTree tree, DumpOptions options)
    {
        writer.WriteStartObject();
        writer.WriteString("language", "shell");
    ...
    private static void WriteNode(Utf8JsonWriter writer, ShellSyntaxNode root, DumpOptions options)
    {
    ...
    private static void WriteTokens(Utf8JsonWriter writer, IReadOnlyList<ShellSyntaxToken> tokens, DumpOptions options)
    {
    ...
    private static void WriteTrivia(Utf8JsonWriter writer, string propertyName, IReadOnlyList<ShellSyntaxTrivia> trivia, DumpOptions options)
    {
