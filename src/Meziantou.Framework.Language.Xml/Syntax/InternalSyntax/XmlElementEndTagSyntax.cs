...
internal sealed class XmlElementEndTagSyntax : XmlSyntaxNode
{
    ...
    internal override GreenNode? WithSlots(ReadOnlySpan<GreenNode?> slots) => new XmlElementEndTagSyntax(slots[0]!, slots[1]!, slots[2], slots[3]!, GetDiagnostics(), GetAnnotations());
