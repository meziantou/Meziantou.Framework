...
internal sealed class XmlProcessingInstructionSyntax : XmlNodeSyntax
{
    ...
    internal override GreenNode? WithSlots(ReadOnlySpan<GreenNode?> slots) => new XmlProcessingInstructionSyntax(slots[0]!, slots[1]!, slots[2]!, slots[3]!, GetDiagnostics(), GetAnnotations());
