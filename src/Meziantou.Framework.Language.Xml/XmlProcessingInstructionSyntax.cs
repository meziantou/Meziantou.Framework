...
public sealed class XmlProcessingInstructionSyntax : XmlSyntaxNode
{
    public XmlProcessingInstructionSyntax(string target, string? data, string fullText, int fullStart = 0)
        : base(XmlSyntaxKind.XmlProcessingInstruction, fullText, [new XmlSyntaxToken(XmlSyntaxKind.ProcessingInstructionToken, fullText, fullStart: fullStart)], fullStart)
    {
        Target = target;
        Data = data;
    }
