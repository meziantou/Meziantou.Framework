...
internal static class Program
{
    ...
    internal static Task<int> MainImpl(string[] args, Action<InvocationConfiguration>? configure)
    {
        ...
        {
            Description = "Validate generated files are up to date without writing changes",
        };
        ...
        rootCommand.SetAction(parseResult =>
        {
            ...
            var validateOnly = parseResult.GetValue(validateOption);
            GenerateFiles(inputs, output, outputFile, options, validateOnly);
    ...
    private static void GenerateFiles(IReadOnlyList<AssemblySource> inputs, string? outputDirectory, string? outputFile, PublicApiOptions options, bool validateOnly)
    {
