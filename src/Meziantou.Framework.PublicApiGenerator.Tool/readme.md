...
Use `--validate` to check that generated files are up to date without writing any file. This is useful in CI:
...
Options:
  ...
  --validate                                                     Validate generated files are up to date without writing changes
