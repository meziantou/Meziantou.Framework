...
Use `--verify-no-change` to check that generated files are up to date without writing any file. This is useful in CI:
...
Options:
  ...
  --verify-no-change                                             Verify generated files are up to date without writing changes
