...
""";
    ...
    private const string StronglyTypedExtensions = @"
// ------------------------------------------------------------------------------
//  <autogenerated>
//      This code was generated by a tool.
//
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// <summary>
///     Extension Methods to identify strongly-typed id's and extract the type of value object which is implemented
///     such as 'string', 'Guid', 'int', or other valid types.
/// </summary>
////////////////////////////////////////////////////////////////////////////////////////////////////
internal static class StronglyTypedIdExtensions
{
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary>
    ///     Returns the type of value object which is implemented in the strongly-typed id value object.
    ///     <para>Such as 'string', 'Guid', 'int' or any other allowed value types. </para>
    /// </summary>
    /// <exception cref=""InvalidDataException"">
    ///     Throws when <paramref name=""stronglyTypedId"" /> is not a strongly-typed id value object
    /// </exception>
    /// <param name=""stronglyTypedId"">  The strongly-typed id to extract the base 'value type' from. </param>
    /// <returns>   Returns the 'Type' of value object</returns>
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    public static Type GetTypeOfStronglyTypedId(this Type stronglyTypedId)
    {
        if (!stronglyTypedId.IsStronglyTypedId())
        {
            throw new InvalidDataException($""The type {stronglyTypedId.Name} is not a strongly typed id"");
        }

        return stronglyTypedId.GetTypeInfo()
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary>
    ///     Returns the type of value object which is implemented in the strongly-typed id value
    ///     object.
    ///     <para>Such as 'string', 'Guid', 'int' or any other allowed value types. </para>
    /// </summary>
    /// <remarks>   Jeff Ward, 11/10/2022. </remarks>
    /// <exception cref=""InvalidDataException"">
    ///     Thrown when an Invalid Data error condition occurs.
    /// </exception>
    /// <param name=""stronglyTypedPropertyInfo"">    The strongly-typed id property to extract the base 'value type' from. </param>
    /// <returns>   Returns the 'Type' of value object. </returns>
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    public static Type GetTypeOfStronglyTypedId(this PropertyInfo stronglyTypedPropertyInfo)
    {
        if (!stronglyTypedPropertyInfo.IsStronglyTypedId())
        {
            throw new InvalidDataException($""The type {stronglyTypedPropertyInfo.Name} is not a strongly typed id property"");
        }

        return stronglyTypedPropertyInfo.PropertyType.GetTypeInfo()
            .GetFields(BindingFlags.NonPublic | BindingFlags.Instance)[0]
            .FieldType;
    }
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary>
    ///     Determines if this <paramref name=""type"" /> has any properties that are strongly-typed id value objects.
    /// </summary>
    /// <param name=""type""> Determines if this type contains any properties that are strongly-typed id value objects. </param>
    /// <returns>   Returns true if this type has properties that are strongly-typed id value objects. </returns>
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    public static bool HasStronglyTypedIdProperty(this Type type)
    {
        return type.GetProperties(BindingFlags.Public | BindingFlags.Instance)
            .Any(_ => _.IsStronglyTypedId());
    }

    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary>
    ///     Determines if the <seealso cref=""PropertyInfo"" /> <paramref name=""pi"" /> is a strongly-typed id value object
    /// </summary>
    /// <param name=""pi""> Determines if this property is a strongly-typed id value object. </param>
    /// <returns>  Returns true if the property is a strongly-typed id value object</returns>
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    public static bool IsStronglyTypedId(this PropertyInfo pi)
    {
        return pi.PropertyType.IsStronglyTypedId();
    }

    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary>
    ///     Determines if the <paramref name=""type"" /> is a strongly-typed id value object.
    /// </summary>
    /// <param name=""type""> Determines if this is a strongly-typed id value object. </param>
    /// <returns>  Returns true if the <paramref name=""type"" /> is a strongly-typed id value object.</returns>
    ////////////////////////////////////////////////////////////////////////////////////////////////////
...
";
    ...
    private const string IStronglyTypedIdInterface = @"
// ------------------------------------------------------------------------------
//  <autogenerated>
//      This code was generated by a tool.
//
