...
public sealed partial class StronglyTypedIdSourceGenerator : IIncrementalGenerator
{
    ...
    private sealed class AttributeInfo : IEquatable<AttributeInfo>
    {
        ...
        public override int GetHashCode()
        {
            ...
            hashcode.Add(IsToStringDefined);
            hashcode.Add(IsGetHashcodeDefined);
            hashcode.Add(IsEqualsDefined);
            hashcode.Add(IsIEquatableEqualsDefined);
            hashcode.Add(IsOpEqualsDefined);
            hashcode.Add(IsOpNotEqualsDefined);
            hashcode.Add(IsTryParseDefined_String);
            ...
            hashcode.Add(SupportMongoDbConverter);
            hashcode.Add(SupportNotNullWhenAttribute);
            hashcode.Add(SupportReadOnlySpanChar);
            hashcode.Add(IsOpLessThanDefined);
            hashcode.Add(IsOpGreaterThanDefined);
            hashcode.Add(IsOpLessThanOrEqualDefined);
            hashcode.Add(IsOpGreaterThanOrEqualDefined);
            hashcode.Add(ImplementsIComparable);
            hashcode.Add(ImplementsIComparable_CompareTo);
            hashcode.Add(ImplementsIComparableOfT);
            hashcode.Add(ImplementsIComparableOfT_CompareTo);
            hashcode.Add(SupportDisallowNullAttribute);
