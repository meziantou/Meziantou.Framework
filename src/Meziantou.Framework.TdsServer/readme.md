...
Main unsupported SQL features include `LIKE`, recursive CTEs, subqueries outside `IN`, correlated subqueries, DML (`INSERT`/`UPDATE`/`DELETE`), and multiple statements/result sets.
