...
Main unsupported SQL features include `LIKE`, recursive CTEs, correlated subqueries, DML (`INSERT`/`UPDATE`/`DELETE`), and multiple statements/result sets.
