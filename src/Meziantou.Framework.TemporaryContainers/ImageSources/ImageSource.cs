...
public abstract record ImageSource
{
	...
	public static ImageSource FromDockerfile(string dockerfilePath, string contextDirectory)
	{
		return new DockerfileImage(dockerfilePath, contextDirectory);
	}
	...
	public static ImageSource FromDockerFile(string dockerfilePath, string contextDirectory)
	{
		return FromDockerfile(dockerfilePath, contextDirectory);
	}
