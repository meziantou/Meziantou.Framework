...
/// <summary>
/// Represents memory statistics for a cgroup.
/// </summary>
public sealed class MemoryStat
{
    /// <summary>
    /// Memory used in anonymous mappings (bytes).
    /// </summary>
    public long Anon { get; private set; }

    /// <summary>
    /// Memory used to cache filesystem data (bytes).
    /// </summary>
    public long File { get; private set; }

    /// <summary>
    /// Total kernel memory (bytes).
    /// </summary>
    public long Kernel { get; private set; }

    /// <summary>
    /// Memory allocated to kernel stacks (bytes).
    /// </summary>
    public long KernelStack { get; private set; }

    /// <summary>
    /// Memory allocated for page tables (bytes).
    /// </summary>
    public long PageTables { get; private set; }

    /// <summary>
    /// Memory used for storing per-cpu kernel data structures (bytes).
    /// </summary>
    public long PerCpu { get; private set; }

    /// <summary>
    /// Memory used in network transmission buffers (bytes).
    /// </summary>
    public long Sock { get; private set; }

    /// <summary>
    /// Memory cached in swap (bytes).
    /// </summary>
    public long SwapCached { get; private set; }

    /// <summary>
    /// Cached filesystem data mapped with mmap (bytes).
    /// </summary>
    public long FileMapped { get; private set; }

    /// <summary>
    /// Cached filesystem data that was modified but not yet written back (bytes).
    /// </summary>
    public long FileDirty { get; private set; }

    /// <summary>
    /// Cached filesystem data being written back to disk (bytes).
    /// </summary>
    public long FileWriteback { get; private set; }

    /// <summary>
    /// Inactive anonymous memory (bytes).
    /// </summary>
    public long InactiveAnon { get; private set; }

    /// <summary>
    /// Active anonymous memory (bytes).
    /// </summary>
    public long ActiveAnon { get; private set; }

    /// <summary>
    /// Inactive file-backed memory (bytes).
    /// </summary>
    public long InactiveFile { get; private set; }

    /// <summary>
    /// Active file-backed memory (bytes).
    /// </summary>
    public long ActiveFile { get; private set; }

    /// <summary>
    /// Unevictable memory (bytes).
    /// </summary>
    public long Unevictable { get; private set; }

    /// <summary>
    /// Reclaimable slab memory (bytes).
    /// </summary>
    public long SlabReclaimable { get; private set; }

    /// <summary>
    /// Unreclaimable slab memory (bytes).
    /// </summary>
    public long SlabUnreclaimable { get; private set; }

    /// <summary>
    /// Total slab memory (bytes).
    /// </summary>
