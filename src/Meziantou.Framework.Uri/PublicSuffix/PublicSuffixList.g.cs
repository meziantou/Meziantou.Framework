...
static partial class PublicSuffixList
{
    ...
    private static ReadOnlySpan<byte> IcannRules => """
        0.bg
        1.bg
        2.bg
        2000.hu
    ...
    private static ReadOnlySpan<byte> PrivateRules => """
        0am.jp
        0g0.jp
        0j0.jp
        0t0.jp
    ...
    private static ReadOnlySpan<byte> IcannWildcards => """
        ck
        er
        fk
        jm
    ...
    private static ReadOnlySpan<byte> PrivateWildcards => """
    ...
    private static ReadOnlySpan<byte> IcannExceptions => """
        city.kawasaki.jp
        city.kitakyushu.jp
        city.kobe.jp
        city.nagoya.jp
    ...
    private static ReadOnlySpan<byte> PrivateExceptions => ""u8;
}