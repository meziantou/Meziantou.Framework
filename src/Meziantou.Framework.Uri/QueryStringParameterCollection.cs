...
public sealed class QueryStringParameterCollection : IEnumerable<KeyValuePair<string, StringValues>>
{
    ...
    /// <summary>
    /// Gets or sets the values for the specified parameter name.
    /// </summary>
    ...
    /// <summary>
    /// Gets the values for the specified parameter name.
    /// </summary>
    /// <param name="name">The parameter name.</param>
    /// <returns>The values associated with the parameter name, or <see cref="StringValues.Empty"/> if not found.</returns>
    ...
    /// <summary>
    /// Appends values to an existing parameter or adds a new parameter if it doesn't exist.
    /// </summary>
    /// <param name="name">The parameter name.</param>
    ...
    /// <summary>
    /// Appends a value to an existing parameter or adds a new parameter if it doesn't exist.
    /// </summary>
    /// <param name="name">The parameter name.</param>
    ...
    /// <summary>
    /// Sets the values for the specified parameter name, replacing any existing values.
    /// </summary>
    /// <param name="name">The parameter name.</param>
