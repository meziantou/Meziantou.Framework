...
public sealed class CommonMarkSpecTests
{
    ...
    private static readonly Dictionary<int, string> SkippedExamples = new()
    {
        ...
        [25] = "Entity references: normalization differs after round-trip",
        [31] = "Entity references: normalization differs after round-trip",
        [39] = "Entity references: normalization differs after round-trip",
        [40] = "Entity references: normalization differs after round-trip",
        [61] = "Thematic breaks: normalization differs after round-trip",
        [76] = "ATX headings: trailing hash handling differs after round-trip",
        [79] = "ATX headings: trailing hash handling differs after round-trip",
        [109] = "Indented code blocks: indentation semantics differ after round-trip",
        [126] = "Fenced code blocks: escaping semantics differ after round-trip",
        [130] = "Fenced code blocks: indentation semantics differ after round-trip",
        [144] = "Fenced code blocks: tag handling differs after round-trip",
        [218] = "Link reference definitions: container shape differs after round-trip",
        [237] = "Block quotes: container shape differs after round-trip",
        [239] = "Block quotes: container shape differs after round-trip",
        [240] = "Block quotes: container shape differs after round-trip",
        [278] = "List items: list tight/loose semantics differ after round-trip",
        [300] = "List items: list tight/loose semantics differ after round-trip",
        [301] = "Lists: list tight/loose semantics differ after round-trip",
        [302] = "Lists: list tight/loose semantics differ after round-trip",
        [304] = "Lists: list tight/loose semantics differ after round-trip",
        [308] = "Lists: list tight/loose semantics differ after round-trip",
        [309] = "Lists: list tight/loose semantics differ after round-trip",
        ...
        [461] = "Emphasis: nested emphasis parsing differs after round-trip",
        [463] = "Emphasis: delimiter run parsing differs after round-trip",
        [464] = "Emphasis: delimiter run parsing differs after round-trip",
        [465] = "Emphasis: delimiter run parsing differs after round-trip",
        [466] = "Emphasis: delimiter run parsing differs after round-trip",
        [468] = "Emphasis: delimiter run parsing differs after round-trip",
        [475] = "Emphasis: delimiter run parsing differs after round-trip",
        [476] = "Emphasis: delimiter run parsing differs after round-trip",
        [477] = "Emphasis: delimiter run parsing differs after round-trip",
        [492] = "Links: destination parsing differs after round-trip",
        [494] = "Links: title parsing differs after round-trip",
        [498] = "Links: destination parsing differs after round-trip",
        [499] = "Links: destination parsing differs after round-trip",
        [500] = "Links: destination parsing differs after round-trip",
        [520] = "Images: alt-text reference resolution differs after round-trip",
        [593] = "Images: destination handling differs after round-trip",
        [613] = "Raw HTML: tag/attribute parsing differs after round-trip",
        [614] = "Raw HTML: tag/attribute parsing differs after round-trip",
        [615] = "Raw HTML: tag/attribute parsing differs after round-trip",
        [616] = "Raw HTML: tag/attribute parsing differs after round-trip",
        [623] = "Raw HTML: parsing differs after round-trip",
        [625] = "Raw HTML: parsing differs after round-trip",
        [626] = "Raw HTML: parsing differs after round-trip",
        [627] = "Raw HTML: parsing differs after round-trip",
        [628] = "Raw HTML: parsing differs after round-trip",
        [629] = "Raw HTML: parsing differs after round-trip",
        [630] = "Raw HTML: parsing differs after round-trip",
        [631] = "Raw HTML: parsing differs after round-trip",
    };
}
