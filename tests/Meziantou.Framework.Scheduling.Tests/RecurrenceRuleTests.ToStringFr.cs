...
public partial class RecurrenceRuleTests
{
    ...
    [InlineData("FREQ=YEARLY;BYMONTH=1,2;BYDAY=MO,TU,WE,TH,FR;BYSETPOS=-1", "tous les ans en semaine en janvier et février, uniquement la dernière occurrence")]
    ...
    [InlineData("FREQ=MONTHLY;BYDAY=MO;BYSETPOS=1,-1;BYHOUR=9,17;BYMINUTE=0", "tous les mois le lundi à 9h00 et 17h00, uniquement la première et la dernière occurrence")]
    ...
    [InlineData("FREQ=WEEKLY;INTERVAL=2;BYDAY=MO,WE;WKST=SU", "toutes les 2 semaines le lundi et mercredi")]
    [InlineData("FREQ=WEEKLY;INTERVAL=2;BYDAY=MO;WKST=SU", "toutes les 2 semaines le lundi")]
    [InlineData("FREQ=WEEKLY;BYDAY=MO,TU;WKST=TU;BYSETPOS=1", "toutes les semaines le lundi et mardi, uniquement la première occurrence, les semaines commençant le mardi")]
